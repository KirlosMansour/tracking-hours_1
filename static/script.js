...
function renderTeamWorkloadView() {
  ...
  document.getElementById("teamWorkloadPanel").classList.remove("hidden");
  document.getElementById("teamForecastPanel").classList.add("hidden");
  document.getElementById("btnViewWorkload").classList.add("active");
  document.getElementById("btnViewForecast").classList.remove("active");
...
function renderTeamForecastingView() {
  showView("teamWorkload");
  document.getElementById("teamWorkloadPanel").classList.add("hidden");
  document.getElementById("teamForecastPanel").classList.remove("hidden");
  document.getElementById("btnViewWorkload").classList.remove("active");
  document.getElementById("btnViewForecast").classList.add("active");
