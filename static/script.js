...
function makeProject(name) {
  return {
    ...
    combinedCells:   {},
    combineSnapshots: {},
    bufferPct:   20,        // % buffer added on top of EAC for next-project estimate
    mw:          null,      // project size in MW (for hrs/MW card)
    projectType: "PV",      // "PV" or "BESS"
    startDate:   "",        // project start date (YYYY-MM-DD)
    endDate:     "",        // estimated end / delivery date
  };
}
